...
U 1 1 615F9685
P 9150 1950
F 0 "J4" H 9200 3067 50  0000 C CNN
F 1 "Conn_02x20_Odd_Even" H 9200 2976 50  0000 C CNN
...
4
Text Notes 8650 1650 2    50   ~ 0
27
Text Notes 8650 1750 2    50   ~ 0
22
Text Notes 8650 2450 2    50   ~ 0
5
Text Notes 8650 2550 2    50   ~ 0
6
Text Notes 8650 2650 2    50   ~ 0
13
Text Notes 8500 2650 2    50   ~ 0
pwm
Text Notes 8650 2850 2    50   ~ 0
26
Text Notes 10050 1350 2    50   ~ 0
gpio 14
Text Notes 9750 1450 0    50   ~ 0
gpio 15
Text Notes 8600 1550 2    50   ~ 0
gpio 17
Text Notes 10000 1550 2    50   ~ 0
pwm
Text Notes 9800 1750 2    50   ~ 0
23
Text Notes 9800 1850 2    50   ~ 0
24
Text Notes 9800 2050 2    50   ~ 0
25
Text Notes 10050 2150 2    50   ~ 0
gpio 8
Text Notes 10050 2250 2    50   ~ 0
gpio 7
Text Notes 9900 2350 2    50   ~ 0
gpio 1
Text Notes 10000 2550 2    50   ~ 0
12 pwm
Text Notes 10150 2750 2    50   ~ 0
gpio 16
Text Notes 10150 2850 2    50   ~ 0
gpio 20
Text Notes 10150 2950 2    50   ~ 0
gpio 21
Text Notes 8750 2150 2    50   ~ 0
gpio 10\ngpio 9\ngpio 11
Text Notes 8750 2350 2    50   ~ 0
gpio 0
...
22
Text Notes 3350 1950 2    50   ~ 0
5
Text Notes 3350 2150 2    50   ~ 0
6
...
gpio 16
Text Notes 4750 1750 2    50   ~ 0
gpio 20
Text Notes 4700 1550 2    50   ~ 0
gpio 21
...
U 1 1 6162B2A1
P 4650 3950
F 0 "R1" H 4582 3904 50  0000 R CNN
F 1 "4.7k" H 4582 3995 50  0000 R CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 4690 3940 50  0001 C CNN
...
U 1 1 6162C8FC
P 4950 3950
F 0 "R2" H 4882 3904 50  0000 R CNN
F 1 "4.7k" H 4882 3995 50  0000 R CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 4990 3940 50  0001 C CNN
...
F 1 "1800" H 3468 3655 50  0000 L CNN
...
F 2 "Diode_SMD:D_1206_3216Metric" H 3400 4050 50  0001 C CNN
...
U 1 1 62475E7F
P 1100 4050
F 0 "J6" H 1150 4267 50  0000 C CNN
F 1 "poe_choice" H 1150 4176 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_2x02_P2.54mm_Vertical" H 1100 4050 50  0001 C CNN
...
U 1 1 62477874
P 1100 4900
F 0 "J7" H 1150 5117 50  0000 C CNN
F 1 "rpi_poe_header" H 1150 5026 50  0000 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_2x02_P2.54mm_Vertical" H 1100 4900 50  0001 C CNN
...
Wire Wire Line
	1100 5200 900  5200
$Comp
L Baja-5v-New-TR:L7806ABD2T-TR CR1
U 1 1 624807BF
P 7100 4350
F 0 "CR1" H 8000 4737 60  0000 C CNN
F 1 "L7806ABD2T-TR" H 8000 4631 60  0000 C CNN
F 2 "baja-new-5v-tr:L7806ABD2T-TR" H 8000 4590 60  0001 C CNN
...
U 1 1 62480E50
P 6700 4750
F 0 "C1" H 6878 4796 50  0000 L CNN
F 1 "0.33u" H 6878 4705 50  0000 L CNN
...
U 1 1 62481D80
P 9550 4650
F 0 "C2" H 9728 4696 50  0000 L CNN
F 1 "0.1u" H 9728 4605 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 9550 4650 50  0001 C CNN
F 3 "~" H 9550 4650 50  0001 C CNN
	1    9550 4650
	1    0    0    -1  
$EndComp
Text Label 6700 5000 3    50   ~ 0
gnd
Text Label 9550 4900 3    50   ~ 0
gnd
Text Label 9000 4600 3    50   ~ 0
gnd
Wire Wire Line
	8900 4450 9000 4450
Wire Wire Line
